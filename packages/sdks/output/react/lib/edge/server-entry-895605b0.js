...
}, V = (t) => t instanceof URLSearchParams ? Y(t) : t, B = (t) => typeof t == "string" ? t : t instanceof URLSearchParams ? t.toString() : new URLSearchParams(t).toString();
function c() {
...
function N(t) {
  return Q() && B(t || window.location.search).indexOf("builder.frameEditing=") !== -1;
}
function Wt(t) {
  if (!c())
    return !1;
  const e = B(t || window.location.search);
  return N(e) ? !1 : e.indexOf("builder.preview=") !== -1;
}
const U = (t) => JSON.parse(JSON.stringify(t)), $t = (t) => ({
  type: "builder.registerComponent",
  data: et(t)
}), Z = (t) => {
  const e = t.toString().trim();
  return `return (${!e.startsWith("function") && !e.startsWith("(") ? "function " : ""}${e}).apply(this, arguments)`;
}, tt = (t) => typeof t == "function" ? Z(t) : U(t), et = ({
  inputs: t,
  ...e
}) => ({
  ...U(e),
...
const R = "builder.", nt = "options.", F = (t) => {
  if (!t)
    return {};
  const e = V(t), n = {};
  return Object.keys(e).forEach((r) => {
    if (r.startsWith(R)) {
      const o = r.replace(R, "").replace(nt, "");
      n[o] = e[r];
    }
  }), n;
}, rt = () => {
...
async function It(t) {
  ...
  if (t.canTrack && !N() && (c() || I === "reactNative"))
...
const Et = "UNKNOWN_VERSION";
let T = !1;
const Ot = (t = {}) => {
  var e, n;
  T || (T = !0, c() && ((e = window.parent) == null || e.postMessage({
  ...
  value: e,
  canTrack: !0
}), J = (t) => m(t.id) && m(t.variations) && Object.keys(t.variations).length > 0, Tt = ({
  id: t,
  variations: e
}) => {
  var o;
...
const Ft = "v3", L = (t) => typeof t == "number" && !isNaN(t) && t >= 0, O = (t) => {
  const {
    limit: e = 30,
    userAttributes: n,
    query: r,
  ...
  if (i.searchParams.set("apiKey", s), i.searchParams.set("limit", String(e)), i.searchParams.set("noTraverse", String(X)), i.searchParams.set("includeRefs", String(!0)), d && i.searchParams.set("locale", d), a && i.searchParams.set("enrich", String(a)), i.searchParams.set("omit", k || "meta.componentsUsed"), p && i.searchParams.set("fields", p), Number.isFinite(u) && u > -1 && i.searchParams.set("offset", String(Math.floor(u))), typeof P == "boolean" && i.searchParams.set("includeUnpublished", String(P)), h && L(h) && i.searchParams.set("cacheSeconds", String(h)), g && L(g) && i.searchParams.set("staleCacheSeconds", String(g)), w) {
    const l = v({
      sort: w
    });
    for (const S in l)
...
const Dt = async (t) => {
  var s;
  const e = O(t);
  return await (await ((s = t.fetch) != null ? s : Ut)(e.href, t.fetchOptions)).json();
}, Kt = async (t, e, n = O(t)) => {
